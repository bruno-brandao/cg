...
export class CisalhamentoPage {
    ...
    ngOnInit() {
        ...
        this.graphics.beginFill(0x345d7e);
        this.graphics.lineStyle(4, 0xf27281, 1);

        // draw a shape
        this.graphics.moveTo(50, 300);
        this.graphics.lineTo(250, 300);
        this.graphics.lineTo(250, 500);
        this.graphics.lineTo(50, 500);
